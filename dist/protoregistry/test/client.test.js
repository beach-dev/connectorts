...
describe('Proto Registry', function () {
    test('checks buildTopicProtoMsgs()', async function () {
        ...
        //     'nakji.test.0_0_0.test_Mint': new Mint(),
        //     'nakji.test.0_0_0.test_Redeem': new Redeem(),
        // }
        ...
        // expect(tpms[0].proto_msg).toBe('nakji.test.test.Mint')
        // expect(tpms[1].msg_type).toBe(MsgType.SYS)
        // expect(tpms[1].topic).toBe('nakji.test.0_0_0.test_Redeem')
        // expect(tpms[1].proto_msg).toBe('nakji.test.test.Redeem')
    });
});
